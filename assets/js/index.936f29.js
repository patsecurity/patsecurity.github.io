...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js3');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/bitmap-174.jpg':'images/bitmap-87.jpg');

var e=document.querySelector('.js2');e.setAttribute('src',(dpi>1)?'images/gex-1100.jpg':'images/gex-550.jpg');};
