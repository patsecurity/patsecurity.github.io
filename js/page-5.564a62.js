...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js10');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/bitmap-174.jpg':'images/bitmap-87.jpg');
};
if(!window.HTMLPictureElement){r();}
ldsrc('.js10');ldsrcset('.js11 source');
});